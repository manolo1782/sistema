...
class VentaController extends Controller
{
    ...
    public function obtenerDetalles(Request $request){
        ...
        ->select('detalle_ventas.cantidad','detalle_ventas.precio','articulos.nombre as articulo','detalle_ventas.descuento','articulos.nombre as articulo')->where('detalle_ventas.idventa','=',$id)
